defmodule Resinmulti do
  @on_load :load_nifs
  def load_nifs do
      IO.puts "load_nifs"
      :erlang.load_nif('/home/imanishi/Desktop/rakugaki/elixir_mix/resinmulti/c_src/lib/resource',0)
      :erlang.load_nif('/home/imanishi/Desktop/rakugaki/elixir_mix/resinmulti/c_src/lib/object',0)
    end
  use Agent
  def count do
  ...
  #rt_obj,rt_obj2の2つを用意してそれぞれ別モジュールでopen_resourceすればいけるのでは？
  defmodule Object do
    #@on_load :load_nifs
    #def load_nifs do
